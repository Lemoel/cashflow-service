...
class AuthRequestTest {
    ...
    fun `ChangePasswordRequest holds currentPassword and newPassword`() {
        val request = ChangePasswordRequestDto(currentPassword = "old123", newPassword = "new456")
    ...
    fun `LoginRequest holds email and password`() {
        val request = LoginRequestDto(email = "user@test.com", password = "senha123")
    ...
    fun `RefreshTokenRequest holds refreshToken`() {
        val request = RefreshTokenRequestDto(refreshToken = "jwt.refresh.token")
